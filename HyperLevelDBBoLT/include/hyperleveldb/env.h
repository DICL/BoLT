...
class Env {
 public:
  ...
  virtual Status NewRandomAccessFileWithSize(const std::string& fname,
                                     RandomAccessFile** result, uint64_t start, uint64_t endOffset) = 0;
...
class EnvWrapper : public Env {
 public:
  ...
  Status NewRandomAccessFileWithSize(const std::string& f, RandomAccessFile** r, uint64_t startOffset, uint64_t endOffset) {
    return target_->NewRandomAccessFileWithSize(f, r, startOffset, endOffset);
  }
